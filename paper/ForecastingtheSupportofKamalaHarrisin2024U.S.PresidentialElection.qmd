...
#| fig-cap: The distribution of the Numeric Grade of the Polls shows that surveys are conducted by highly rated pollsters, which ensure the reliability of the analysis.
#| echo: false
#| warning: false
#| message: false
...
#| fig-cap: The distribution of the Support Percentage of Kamala Harris clustered around 50%, with the majority of support falling between 40% and 55%.
#| echo: false
#| warning: false
#| message: false
...
msummary(
  ...
  fmt = fmt_significant(3),coef_omit="state|pollster",notes = "Note. All models include a control for state and pollsters. The reference level of state is Alaska, the reference level of population is likely voter, and the reference level of pollsters is Angus Reid.")
```
...
msummary(
  ...
  fmt = fmt_significant(3),coef_omit="state|pollster",notes = "Note. All models include a control for state and pollsters. The reference level of state is Alaska,the reference level of population is likely voter, and the reference level of pollsters is ABC/Washington Post.")
```
