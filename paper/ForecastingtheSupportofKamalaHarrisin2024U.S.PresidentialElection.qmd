...
#| tbl-cap: Harris leads in Democratic-leaning states, showing strong support in reliably blue areas. In pivotal swing states, she maintains competitive support, with Wisconsin at 49% and Pennsylvania at 48.3%, reflecting her appeal in regions important for a potential electoral victory. However, in traditionally Republican strongholds, indicating areas where additional campaign efforts might bolster her standing. Nationally, Harris averages 47.9%, underscoring the competitive landscape as election day nears.
#| echo: false
#| warning: false
#| message: false
...
kable(harris_data_state, caption = "Average Support for Kamala Harris by State")
