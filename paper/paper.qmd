...
The data cleaning process involved filtering data to just high-quality pollsters (i.e numeric_grade >= 3.0) and filter to just Harris (i.e. candidate_name == "Kamala Harris")
