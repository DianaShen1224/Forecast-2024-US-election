...
providing a more accurate reflection of current public opinion. Overall, both models consistently indicate a lead for Harris, with the weighted model slightly stabilizing the predictions. The average support for Harris and Trump are both consist for two models, which predicts that Harris will win on about 49%, leads Trump by about 2%.
...
Pennsylvania, Michigan, and Wiscosin, where she shows a clearer
...
#| fig-subcap: ["Unweighted","Weighted"]
#| layout-ncol: 2
#| fig-cap: "Harris is likely to lead Trump in Pennsylvania, North Carolina, and Wisconsin by Model Prediction"
...
27, 2024, using the unweighted and weighted multiple linear regression model. The red
